...
LOCAL_IMAGE="kam_track"
TAG="latest"
NAMESPACE="default"
SECRET_NAME="kam-track-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="kam_track"
    KUBE_DEPLOYMENT="kam-track-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="kam_track_mac"
    KUBE_DEPLOYMENT="kam-track-mac-app"
